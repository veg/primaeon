/**
 * postprocess.test.js — ported from datamonkey3/src/test/axomeme-postprocess.test.js (main@fac1330).
 *
 * The `isSiteVariable` and `siteVariability` cases are NOT here: those functions moved to the
 * library (@veg/hyphaeon-js, src/preprocess/variability.js) with their tests. What remains
 * exercises `buildPredictions` — the result semantics that stayed in the app's runtime.
...
import { buildPredictions, CALL_DEFAULTS, NEUTRAL_CALL } from '../src/postprocess.js';
