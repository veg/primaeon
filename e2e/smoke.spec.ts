 ...
 * WHICH URLS THE PAGE REQUESTS, per route, starting with the landing page:
 *
 ...
 *   4. The response carries COOP/COEP (D13), so SharedArrayBuffer and multi-threaded ORT are
 *      available on this origin. Here they come from vite.config.ts's preview headers; in
...
test.describe('landing page', () => {
	...
	test('is served cross-origin isolated (COOP/COEP)', async ({ page }) => {
