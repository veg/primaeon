...
compiled build, vendored in the runtime, falling back to the library's JavaScript port of the tn93
package when it will not load (`list_models` reports which under `native.tree_free`). The same
library codes are
